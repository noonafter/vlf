...
void udp_wave_config::createDefaultConfig() {
    ...
    wave_config_vec = {
            {13, 9900,  192000, "FSK", 75,  150, 500, 100},
            {14, 10200, 192000, "MSK", 75,  0,   500, 50},
            {14, 10500, 192000, "MSK", 75,  1,   500, 150},
            {14, 10800, 192000, "FSK", 75,  150, 500, 50},
            {14, 11100, 192000, "MSK", 75,  3,   500, 150},
            {14, 11400, 192000, "FSK", 150, 300, 500, 100}
    };
